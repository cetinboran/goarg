...
func main() {
	...
	a.AddOption("-h,--host,-5", false, "Enter your host.", []string{"Please enter a ip not a domain."})
	...
	a.AddOption("--fast", true, "Makes it faster.", []string{"If you dont have enough ram. It can be slower than faster."})
